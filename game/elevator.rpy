init python:
    ...
    class ElevatorDisplayable(renpy.Displayable):
        ...
        def render(self, width, height, st, at):
            ...
            if self.by < ball_top:
                ...
                if not self.stuck:
                    renpy.sound.play("sound/sfx/elevatorDing.ogg", channel=0)
            ...
            def paddle(px, py, hotside):
                ...
                if py - self.PADDLE_HEIGHT / 2 <= self.by <= py + self.PADDLE_HEIGHT / 2:
                    ...
                    if hit:
                        renpy.sound.play("sound/sfx/elevatorDing.ogg", channel=1)
                        self.bspeed *= 1.10
        ...
        def event(self, ev, x, y, st):
            ...
            if ev.type == pygame.MOUSEBUTTONDOWN and ev.button == 1:
                ...
                # Ensure the elevator screen updates.
...
screen elevator():
    ...
    default elevator = ElevatorDisplayable()
...
label elevator:
    ...
    window hide  # Hide the window and  quick menu while in elevator
    $ quick_menu = False
