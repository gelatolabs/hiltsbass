label start:
    ...
    "He slams the phone down and greets you in a sultry voice."
    ...
    "He presents a stack of 4 different magazines on the desk infront of you." #These could be used to depict the 4 choices as well (content of the magazines)
    lust "Choose your poison, you nasty little freak!"  
    "You slowly spread them out and get an unsettling feeling when you realize the pages are sticky.  You carefully inspect the covers: (Fun with buns, Deep n cheep, Blowin for owin, Smokey or chokey bbq).  How shall you proceed?"
