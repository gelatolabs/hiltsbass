...
define clippi   = Character("Clerk of Learning and Information for Perpetual Pergatorial Imprisonment", color="#FF0000")
define lust     = Character("Lust")
define gluttony = Character("Gluttony")
define greed    = Character("Greed")
define wrath    = Character("Wrath")
define heresy   = Character("Heresy")
define violence = Character("Violence")
define fraud    = Character("Fraud")
define satan    = Character("Satan")
